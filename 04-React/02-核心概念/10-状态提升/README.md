...
接下来, 我们创建一个名为 Calculator 的组件。它渲染一个用于输入温度的 <code>input</code>，并将其值保存在 this.state.temperature 中。
...
在 React 中，这个问题通常是通过使用“受控组件”来解决的。与 DOM 中的 <code>input</code> 接受 value 和 onChange 一样，自定义的 TemperatureInput 组件接受 temperature 和 onTemperatureChange 这两个来自父组件 Calculator 的 props。
...
<img src="https://react.docschina.org/ef94afc3447d75cdc245c77efb0d63be/react-devtools-state.gif" style="height:353px;width:auto;margin:0 auto">