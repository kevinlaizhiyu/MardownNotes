...
有时，语义化的 HTML 会被破坏。比如当在 JSX 中使用 <code>div</code> 元素来实现 React 代码功能的时候，又或是在使用列表（<code>ol</code>，<code>ul</code> 和<code>dl</code>， ）和 HTML <code>table</code> 时。 在这种情况下，我们应该使用 React Fragments 来组合各个组件。
...
所有的 HTML 表单控制，例如 <code>input</code> 和 <code>textarea</code> ，都需要被标注来实现无障碍辅助功能。我们需要提供屏幕朗读器以解释性标注。
...
<img src="https://react.docschina.org/static/dec0e6bcc1f882baf76ebc860d4f04e5/4fcfe/keyboard-focus.png" style="width:146px;height:auto;margin:0 auto;">
...
另外，使用地标元素和角色，比如 <code>main</code> 和 <code>aside</code>，作为辅助来划分网页的区域可以让用户快速导航至这些部分。
